...
router.get('/docente/:id_docente',  validarToken,GrupoController.obtenerPorDocente);
router.get('/director/:id_director', validarToken, GrupoController.obtenerPorDirector);
